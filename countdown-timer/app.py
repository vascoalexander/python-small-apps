...
def set_timer():
    ...
    set_timer_label = tk.Label(set_timer_window, text="Enter time in seconds: ", font=("Arial", 16))
    set_timer_label.pack()
    set_timer_entry = tk.Entry(
        set_timer_window, justify="center", font=("Arial", 24), textvariable=countdown_time
    )
...
label_time = tk.Label(window, bg="black", fg="#00FF00", text="00:00:00", font=("Arial", 48, "bold"))
label_time.pack()
