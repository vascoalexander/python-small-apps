...
def calculate_bmi():
    try:
        if float(entry_weight.get()) == 0 or float(entry_height.get()) == 0:
...
label_title = ttk.Label(
    window, text="BMI-Calculator", font=("Arial", 20, "bold"), foreground="pink"
)
...
label_bmi = ttk.Label(frame_bottom, text="Your BMI: ", font=("Arial", 12))
label_result = ttk.Label(frame_bottom, text=0.0, font=("Arial", 12, "bold"))
label_category_text = ttk.Label(
    frame_bottom, text="According to the WHO Definition, your BMI-Category is: "
)
