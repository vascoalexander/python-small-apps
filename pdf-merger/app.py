...
entry_path = tk.Entry(
    window, font=("Arial", 12, "italic"), fg="gray", bg="black", width=300, justify=tk.CENTER
)
...
label_path = tk.Label(
    window, fg="gray", font=("Arial", 12, "italic"), text="path to your file", pady=5
)
label_path.pack()
...
label_filename = tk.Label(
    window, fg="gray", font=("Arial", 12, "italic"), text="name of the merged pdf-file", pady=5
)
label_filename.pack()
