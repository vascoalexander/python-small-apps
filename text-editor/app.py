    ...
    if filepath:
        try:
            ...
            messagebox.showerror(
                ...
                message="Error decoding the file. Make sure the loaded file is in UTF-8 encoding.",
            )
...
def save_as():
    ...
    try:
        ...
        messagebox.showerror(
            title="File Save Error", message=f"An error occured saving the file: {e}"
        )
...
open_image = ttk.PhotoImage(file="./icons/folder-open.png")
save_image = ttk.PhotoImage(file="./icons/disk.png")
save_as_image = ttk.PhotoImage(file="./icons/save-as.png")
exit_image = ttk.PhotoImage(file="./icons/leave.png")
dark_image = ttk.PhotoImage(file="./icons/dark-mode.png")
light_image = ttk.PhotoImage(file="./icons/light-mode.png")

open_image_light = ttk.PhotoImage(file="./icons/folder-open_light.png")
save_image_light = ttk.PhotoImage(file="./icons/disk_light.png")
save_as_image_light = ttk.PhotoImage(file="./icons/save-as_light.png")
exit_image_light = ttk.PhotoImage(file="./icons/leave_light.png")
dark_image_light = ttk.PhotoImage(file="./icons/dark-mode_light.png")
light_image_light = ttk.PhotoImage(file="./icons/light-mode_light.png")
...
button_toggle = ttk.Checkbutton(
    master=frame_modes, bootstyle="light-round-toggle", command=set_mode, variable=toggle_state
)
...
text_area = ttk.Text(
    frame_main, bg="white", fg="dark gray", font=("Arial", 12), yscrollcommand=scrollbar.set
)
